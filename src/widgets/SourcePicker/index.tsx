    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, height: '100%' }}>
      <div>
        ...
        <p style={{ margin: 0, opacity: 0.8, fontSize: '0.95rem', lineHeight: 1.6 }}>
          Tambahkan folder yang berisi musikmu. Michie akan memindai dan menambahkan lagu-lagunya ke library.
        </p>
      </div>

      <ScanProgress isScanning={isScanning} current={scanCurrent} length={scanLength} />

      <div style={{ display: 'flex', gap: 10 }}>
        <div style={{ flex: 1 }}>
          <AddFolderButton onClick={handleAddFolder} disabled={isBusy || isScanning} />
        </div>
